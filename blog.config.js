...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '欢迎访问华中农业大学生物信息学硕士郑孟卓的个人主页！,Welcome to the profile of Zheng Mengzhuo，MSc Bioinformatics，Huazhong agricultural university!',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'BioinfoZMZ：一个灵魂的独白', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'MSc bioinformatics, HZAU, focusing on Omics Data, Literature, Music and Travel', // 作者简介
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mengzhuo2017@webmail.hzau.edu.cn', // 邮箱地址 例如mail@tangly1024.com
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/self.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
